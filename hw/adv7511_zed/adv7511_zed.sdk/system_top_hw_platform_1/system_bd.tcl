...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set gpio_data [ create_bd_port -dir O -from 0 -to 0 -type data gpio_data ]
  set gpio_data1 [ create_bd_port -dir O -from 0 -to 0 -type data gpio_data1 ]
  set gpio_valid [ create_bd_port -dir O -from 0 -to 0 -type data gpio_valid ]
  set gpio_valid1 [ create_bd_port -dir O -from 0 -to 0 -type data gpio_valid1 ]
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {0} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {1} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0

  # Create instance: axi_gpio_1, and set properties
  set axi_gpio_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_1 ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {0} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {1} CONFIG.C_IS_DUAL {0} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_1
  ...
  set_property -dict [ list CONFIG.DMA_TYPE {1} CONFIG.S_AXI_ADDRESS_WIDTH {16}  ] $axi_i2s_adi
  ...
  set_property -dict [ list CONFIG.DMA_TYPE {1} CONFIG.S_AXI_ADDRESS_WIDTH {16}  ] $axi_spdif_tx_core
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {16} CONFIG.IN1_WIDTH {16} CONFIG.IN2_WIDTH {16} CONFIG.IN3_WIDTH {16} CONFIG.NUM_PORTS {4}  ] $xlconcat_1
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M08_AXI [get_bd_intf_pins axi_cpu_interconnect/M08_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_hdmi_core/vdma_data] [get_bd_pins xlconcat_1/dout]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x41210000 [get_bd_addr_spaces sys_ps7/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
